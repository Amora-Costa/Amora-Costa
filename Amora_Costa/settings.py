"""
Django settings for Amora_Costa project.
...
env = environ.Env(DEGUB=(bool,False))
...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS',default ='127.0.01')


# Application definition

INSTALLED_APPS = [
    'Amora.apps.AmoraConfig',
...
WSGI_APPLICATION = 'Amora_Costa.wsgi.application'
